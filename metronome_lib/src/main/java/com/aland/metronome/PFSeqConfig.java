...
import static com.aland.metronome.PFSeqService.LOG_EOL;
import static com.aland.metronome.PFSeqService.LOG_TAG;
import static com.aland.metronome.PFSeqService.MILLIS_PER_SECOND;


public class PFSeqConfig implements Parcelable {
    private static final String KEY_NOT_FOUND = "key not found - ";
    private static final int TAG_CONFIG_NOTIFY_ID = 1000;
    ...
    public static final HashMap<String, Integer> INT_DEFAULTS = new HashMap<String, Integer>() {{
        ...
        put(ONGOING_NOTIF_ID, TAG_CONFIG_NOTIFY_ID);
...
//        }
    ...
    public static final Creator<PFSeqConfig> CREATOR = new Creator<PFSeqConfig>() {
        /**
         * 从序列化对象中，获取原始的对象
         * @param source
         * @return
         */
        @Override
        public PFSeqConfig createFromParcel(Parcel source) {
            return new PFSeqConfig();
        }
         ...
         */
        @Override
        public PFSeqConfig[] newArray(int size) {
            return new PFSeqConfig[0];
        }
    };
