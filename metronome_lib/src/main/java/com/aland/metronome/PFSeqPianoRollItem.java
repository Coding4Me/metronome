...
import static com.aland.metronome.PFSeqConfig.REPEATING;
...
public class PFSeqPianoRollItem {
    ...
    public PFSeqPianoRollItem(PFSeqService seq, PFSeqClip clip, String name, PFSeqTimeOffset timeOffset) {
        this.seq = seq;
        this.name = name;
