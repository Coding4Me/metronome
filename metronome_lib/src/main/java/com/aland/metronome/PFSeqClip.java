...
import static com.aland.metronome.PFSeqService.MICROS_PER_SECOND;
import static com.aland.metronome.PFSeqService.NANO_PER_MICROS;
import static com.aland.metronome.PFSeqConfig.MAX_CLIP_FRAMES;
...
public class PFSeqClip {
    ...
    public PFSeqClip(PFSeqService seq, File file) {
        this.file = file;
        this.seq = seq;
